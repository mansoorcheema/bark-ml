...
class PPOAgent(TFAAgent):
  ...
  def get_agent(self, env, params):
    ...
    tf_agent = ppo_agent.PPOAgent(
      ...
      entropy_regularization=self._params["ML"]["Agent"]["entropy_regularization", "", 0.],
      value_function_l2_reg=self._params["ML"]["Agent"]["policy_l2_reg", "", 0.],
      importance_ratio_clipping=self._params["ML"]["Agent"]["importance_ratio_clipping", "", 0.],
      use_gae=self._params["ML"]["Agent"]["use_gae", "", 0.85],
