...
class PPOAgent(TFAAgent):
  ...
  def get_agent(self, env, params):
    ...
    tf_agent = ppo_agent.PPOAgent(
      ...
      actor_net=actor_net,
      value_net=value_net,
      policy_l2_reg=self._params["ML"]["Agent"]["policy_l2_reg", "", 0.01],
      entropy_regularization=self._params["ML"]["Agent"]["entropy_regularization", "", 0.01],
      value_function_l2_reg=self._params["ML"]["Agent"]["policy_l2_reg", "", 0.01],
      importance_ratio_clipping=self._params["ML"]["Agent"]["importance_ratio_clipping", "", 0.1],
